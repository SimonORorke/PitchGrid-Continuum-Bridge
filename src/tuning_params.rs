...
impl TuningParams {
    pub fn new(depth: i32, mode: i32, root_freq: f32, stretch: f32, skew: f32,
               mode_offset: i32, steps: i32) -> Self {
        Self { depth, mode, root_freq, stretch, skew, mode_offset, steps }
    }

    /// This is not a meaningful default. It's just here so we don't have to encapsulate
    /// TuningParams instances in Options.
    pub fn default() -> Self {
        Self { depth: 0, mode: 0, root_freq: 0.0, stretch: 0.0, skew: 0.0,
            mode_offset: 0, steps: 0 }
    }
