...
fn on_tuning_received() {
    ...
    // println!(
    //     "tuner_tests.on_tuning_received: root_freq = {}; stretch = {}; skew = {}; mode_offset = {}; \
    //     steps = {}; mos_large_step_count = {}; mos_small_step_count = {}",
    //     formatted.root_freq, formatted.stretch, formatted.skew, formatted.mode_offset,
    //     formatted.steps, formatted.mos_large_step_count, formatted.mos_small_step_count);
